...
def default_application_config() -> dict:
    """
...
#     def ISO_UTC_TIMESTAMP(cls) -> str:
#         return datetime.now(tz=timezone.utc).isoformat()
#
#
#     def create_config_dir(cls) -> Path:
#         if 'config_dir' not in cls:
#             config_dir = Path.home().joinpath('.moduli-assembly/.moduli')
#         else:
#             config_dir = cls['config_dir'].joinpath('.moduli')
#
...
#
#
#     def generate_candidates(cls, key_length: int, count: int, conf: dict) -> Path:
...
#
#
#     def write_moduli_file(cls, path: Path, conf: dict) -> None:
...
#
#
#     def restart_candidate_screening(cls, conf) -> None:
...
#
#
#     def clear_artifacts(cls, conf: dict) -> None:
